...
class ProductController:
    ...
    def get_all():
        try:
            return MongoService.find_all('products'), 200
    ...
    def add_product(data, file=None):
        try:
            ...
            result = MongoService.insert_one('products', new_product)
    ...
    def update_product(product_id, data, file=None):
        try:
            ...
            result = MongoService.update_one('products', {'id': int(product_id)}, update_data)
